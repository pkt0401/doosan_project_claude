...
with tabs[0]:
    ...
    with col1:
        st.markdown("""
        #### AI 위험성평가 자동생성 시스템 (Phase 1 & 2)
        - 사우디 3개 및 이집트 PJT 위험성평가 자료 학습
        - 작업활동 입력 시 유해위험요인 및 위험도 자동 예측
        - 대규모 언어 모델(LLM) 기반 위험도 측정
        - 생성형 AI 기반 개선대책 자동 생성
        - 개선 전후 위험도(T) 및 감소율(RRR) 계산
        """)
    ...
    with col2:
        ...
        - 두산 건설현장 통합 AI 사고 예측 프로그램 개발 착수 (계획)
        - 실시간 안전 모니터링 시스템 연계 (향후 계획)
        """)
